function [almc,dalmc] = ALM_constraint(Xc,nely,nY,np,p)
...
tv1 = ((tanalpha(:) - tand(35))/tand(35));
tv2= ((tanbeta(:) - tand(35))/tand(35));
TV=[tv1;tv2];
[almc,dalmc_dtv]=Aggregation_Pi(TV,p);
almc=almc*100;

dtv1_dXk = ((dtanalpha_dXk)/tand(35));
dtv1_dLk = ((dtanalpha_dLk)/tand(35));
dtv2_dXk = ((dtanbeta_dXk)/tand(35));
dtv2_dLk = ((dtanbeta_dLk)/tand(35));
